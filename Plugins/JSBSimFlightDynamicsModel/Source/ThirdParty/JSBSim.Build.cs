...
public class JSBSim : ModuleRules
{
    ...
    private void SetupUnixPlatform()
    {
        ...
        {
            string MacLibPath = CheckForFile(LibPath, "libJSBSim.dylib");
            PublicAdditionalLibraries.Add(MacLibPath);
            RuntimeDependencies.Add(MacLibPath);
        }
        ...
        {
            string AndroidLibPath = CheckForFile(LibPath, "libJSBSim.so");
            PublicAdditionalLibraries.Add(AndroidLibPath);
            RuntimeDependencies.Add(AndroidLibPath);
